...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests(authz -> authz
            ...
            .requestMatchers(HttpMethod.GET, "/app/products", "/app/products/query").permitAll()
            .requestMatchers(HttpMethod.GET, "/app/products/latest-products").permitAll()
            ...
            .requestMatchers(HttpMethod.DELETE, "/app/transactions/{id}").permitAll()
            ...
            .requestMatchers(HttpMethod.POST, "/app/send-email").permitAll()
